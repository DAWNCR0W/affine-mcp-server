 ...
 */
const OUTPUT_SPECS = {
  add_mindmap_node: fallible(spec({ ok: "boolean", workspaceId: "string", docId: "string", surfaceBlockId: "string", mindmapId: "string", rootId: "string", layout: "string", layoutType: "number", style: "number", locked: "boolean", lockedBySelf: "boolean", lockedByAncestor: "boolean", nodeCount: "number", nodes: "unknownArray", supportedLayouts: "stringArray" })),
  create_mindmap: fallible(spec({ ok: "boolean", workspaceId: "string", docId: "string", surfaceBlockId: "string", mindmapId: "string", rootId: "string", layout: "string", layoutType: "number", style: "number", locked: "boolean", lockedBySelf: "boolean", lockedByAncestor: "boolean", nodeCount: "number", nodes: "unknownArray", supportedLayouts: "stringArray" })),
  ...
  reparent_mindmap_node: fallible(spec({ ok: "boolean", workspaceId: "string", docId: "string", surfaceBlockId: "string", mindmapId: "string", rootId: "string", layout: "string", layoutType: "number", style: "number", locked: "boolean", lockedBySelf: "boolean", lockedByAncestor: "boolean", nodeCount: "number", nodes: "unknownArray", supportedLayouts: "stringArray" })),
  ...
  update_mindmap_node: fallible(spec({ ok: "boolean", workspaceId: "string", docId: "string", surfaceBlockId: "string", mindmapId: "string", rootId: "string", layout: "string", layoutType: "number", style: "number", locked: "boolean", lockedBySelf: "boolean", lockedByAncestor: "boolean", nodeCount: "number", nodes: "unknownArray", supportedLayouts: "stringArray" })),
