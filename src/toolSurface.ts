...
const TOOL_GROUPS: Record<ToolName, readonly string[]> = {
  ...
  append_paragraph: ["docs", "docs.write", "convenience", "write"],
  append_semantic_section: ["docs", "docs.semantic", "docs.write", "write"],
  batch_create_docs: ["docs", "docs.bulk", "docs.markdown", "docs.write", "write"],
  cleanup_blobs: ["blobs", "blobs.write", "cleanup", "destructive", "write"],
  cleanup_orphan_embeds: ["docs", "docs.cleanup", "docs.write", "cleanup", "write"],
  ...
  create_doc_from_template: ["docs", "docs.template", "docs.markdown", "convenience", "write"],
  ...
  duplicate_doc: ["docs", "docs.markdown", "convenience", "write"],
  ...
  find_and_replace: ["docs", "docs.write", "convenience", "write"],
  ...
  get_doc_by_title: ["docs", "docs.read", "docs.markdown", "convenience", "read"],
  get_docs_by_tag: ["docs", "docs.tags", "docs.read", "convenience", "read"],
  ...
  list_backlinks: ["docs", "docs.tree", "docs.read", "convenience", "read"],
  ...
  list_unresolved_threads: ["comments", "comments.read", "convenience", "read"],
  ...
  update_database_cell: ["docs", "docs.database", "docs.write", "convenience", "write"],
